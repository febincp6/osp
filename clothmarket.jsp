<%-- 
    Document   : clothmarket
    Created on : Aug 27, 2019, 5:53:46 PM
    Author     : lenovo
--%>
...
<html>
    ...
    <center><table class="tbl2"><tr style='background-color:black;color:white;'><td>Brand</td><td>Mobile name</td><td>Price</td><td>id</td></tr>
            ...
            <% try{
                ResultSet rs=st.executeQuery("select id,brand,price,forperson,type,size,color,uploadedby  from cloths");
                int k;
    ...
    <form action="clothmarket.jsp" method="post" onsubmit="return validateform()" name="myform" >
        <table>
            <tr>
                <td>Enter Product Id:<input type="text" name="productid"></td>
